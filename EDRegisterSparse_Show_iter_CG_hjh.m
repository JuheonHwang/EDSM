...
function P0 = runOptim(P0, iteration, SrcMesh, pntTar, faceTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_, show_iteration, show_final)
    ...
    for i = 1:iteration
        lambda_in = lambda;
        [F, J, P0, lambda, Gradient, delta] = EfuncLocal(F, J, P0, lambda, SrcMesh, pntTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_);
...
function [F_new, J_new, P0, lambda, Gradient, delta] = EfuncLocal(F_old, J_old, P0, lambda, SrcMesh, pntTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_, indices)  
    ...
    if nargout == 2
        ...
        while true
            ...
            for i = 1:length(b)
                ...
                residuals = [residuals; sqrt(r_new)];
                if sqrt(r_new) < 1e-10
                    break
                end
