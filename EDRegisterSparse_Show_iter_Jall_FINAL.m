...
P0 = runOptim(P0, gpuSrcMesh, pntTar, TarMesh.Fpoi, gpuArray(G0), nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, gpuArray(Lap), w_rot, w_smooth, w_lap, R0, T0, A0, t0, show_iteration, show_final);
...
%     'FunctionTolerance', 1e-10, 'MaxIterations', PARAM.max_iterations, 'OutputFcn',@outfun);
    ...
    'FunctionTolerance', 1e-10, 'MaxIter', 30, 'OutputFcn',@outfun);
