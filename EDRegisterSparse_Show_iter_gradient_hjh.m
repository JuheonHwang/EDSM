...
P0 = runOptim(P0, iteration, step_size, gpuSrcMesh, pntTar, TarMesh.Fpoi, gpuArray(G0), nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, gpuArray(Lap), w_rot, w_smooth, w_lap, R0, T0, A0, t0, show_iteration, show_final);
...
function P0 = runOptim(P0, iteration, step_size, SrcMesh, pntTar, faceTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_, show_iteration, show_final)
    tic;
    disp_lims = [];
    
    for i = 1:iteration

        [P0, F] = EfuncLocal(P0, step_size, SrcMesh, pntTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_);
...
function [P0, F] = EfuncLocal(P0, step_size, SrcMesh, pntTar, G0, nodeIdx, idxNeighbor, idxNodeNeighbor, distNeighbor, Lap, w_rot, w_smooth, w_lap, R_, T_, A_, t_, indices)  
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Gradient%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Gradient = 2 * (F' * J)';
    P0(1:6) = P0(1:6) - step_size*0.01 * Gradient(1:6);
    P0(7:end) = P0(7:end) - step_size * Gradient(7:end);
